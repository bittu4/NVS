...
export default {
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#fff',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#000000' : '#000000',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#000000' : '#000000',
