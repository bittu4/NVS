...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#fff' : '#fff',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#737373' : '#000000',
  ...
  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#000000',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#fff',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : '#000000',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#007aff' : '#000000',
  ...
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#000000',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#007aff' : '#000000',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#000000',
